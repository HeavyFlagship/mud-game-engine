...
>   - [3.1 时间轴状态](#31-时间轴状态)
>   - [3.2 事件对象](#32-事件对象)
>   - [3.3 持续动作对象](#33-持续动作对象)
> - [4 API 参考](#4-api-参考)
>   - [4.1 生命周期](#41-生命周期)
>   - [4.2 事件处理器注册](#42-事件处理器注册)
>   - [4.3 更新器注册](#43-更新器注册)
>   - [4.4 事件调度](#44-事件调度)
>   - [4.5 持续动作](#45-持续动作)
>   - [4.6 推进控制](#46-推进控制)
> - [5 运行机制](#5-运行机制)
>   - [5.1 Tick 流程](#51-tick-流程)
>   - [5.2 推进驱动](#52-推进驱动)
>   - [5.3 暂停机制](#53-暂停机制)
> - [6 战斗系统作为消费者](#6-战斗系统作为消费者)
>   - [6.1 事件处理器注册](#61-事件处理器注册)
>   - [6.2 更新器注册](#62-更新器注册)
>   - [6.3 生命周期集成](#63-生命周期集成)
>   - [6.4 回合调度](#64-回合调度)
> - [7 持续动作与移动](#7-持续动作与移动)
>   - [7.1 移动动作的创建](#71-移动动作的创建)
>   - [7.2 移动与其他动作的并行](#72-移动与其他动作的并行)
>   - [7.3 移动中断](#73-移动中断)
> - [8 玩家决策与暂停](#8-玩家决策与暂停)
>   - [8.1 决策点](#81-决策点)
>   - [8.2 决策点行为](#82-决策点行为)
...
>   - [9.2 时间显示](#92-时间显示)
>   - [9.3 刷新机制](#93-刷新机制)
> - [10 已解决的关键问题](#10-已解决的关键问题)
>   - [10.1 移动进度条残留](#101-移动进度条残留)
>   - [10.2 首次移动不生效](#102-首次移动不生效)
>   - [10.3 武器就绪打断移动](#103-武器就绪打断移动)
>   - [10.4 移动中切换移动不询问开火](#104-移动中切换移动不询问开火)
> - [11 扩展指南](#11-扩展指南)
>   - [11.1 新增事件类型](#111-新增事件类型)
>   - [11.2 新增持续动作类型](#112-新增持续动作类型)
>   - [11.3 接入新系统（如生产制造）](#113-接入新系统如生产制造)
>   - [11.4 注意事项](#114-注意事项)
