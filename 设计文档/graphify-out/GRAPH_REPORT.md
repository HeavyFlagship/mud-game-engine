# Graph Report - /workspace/设计文档  (2026-08-03)

## Corpus Check
- Corpus is ~18,628 words - fits in a single context window. You may not need a graph.

## Summary
- 401 nodes · 400 edges · 77 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Structure Signals
- Entity graph basis: 400 non-file, non-concept node(s)
- Weakly connected components: 2
- Singleton components: 0
- Isolated nodes: 0
- Largest component: 390 node(s) (98% of the entity graph basis)
...
4. `1 概述` - connects `1 3`, `10 Amm`, `Community 43`, `Community 71`; home: `1`; degree 14; score 63.5
...
- **[HIGH] Bridge node** - 1 概述 bridges 1 and Community 71, Community 43, 1 3.
...
### Community 76 - "Markdown"
Cohesion (entity basis within full-graph community): n/a
Nodes (0): 

## Knowledge Gaps
- **319 weakly connected node(s):** `1.1 游戏背景（装备相关）`, `1.2 物品属性字段`, `2.1 星球网格与坐标`, `2.2.1 轨道与自转`, `2.2.2 大气成分（还原性大气）` (+314 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 71`** (2 nodes): `战斗模式`, `时间轴回合制`
...
- **Why does \`1 概述\` connect \`1\` to \`Community 71\`, \`Community 43\`, \`1 3\`?**
  _High betweenness centrality \(9.500\) - this node is a cross-community bridge._
- **What connects \`1.1 游戏背景（装备相关）\`, \`1.2 物品属性字段\`, \`2.1 星球网格与坐标\` to the rest of the system?**
